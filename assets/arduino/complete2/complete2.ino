...
const char *topic = "flipkart/bot2";
...
//  serial.println(AlPwm);
  ...
  analogWrite(Driver1_A_PWM, AlPwm+0);
  analogWrite(Driver1_B_PWM, ArPwm+0);
  ...
  analogWrite(Driver2_B_PWM, BrPwm+25);
  analogWrite(Driver2_A_PWM, BlPwm+25);
  ...
  if (rot == 1) {
    ...
    analogWrite(Driver1_A_PWM, 100);
    analogWrite(Driver1_B_PWM, 100);
    //Driver Driver 2
    ...
    analogWrite(Driver2_A_PWM, 100);
    analogWrite(Driver2_B_PWM, 100);
